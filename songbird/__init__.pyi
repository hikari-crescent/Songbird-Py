...
class Driver:
    ...
    async def play_source(self, source: Source) -> None: ...
    async def mute(self) -> None: ...
    async def unmute(self) -> None: ...
    async def is_muted(self) -> None: ...
    async def play_source(self, source: Source) -> None: ...
    async def play_only_source(self, source: Source) -> None: ...
...
class TrackHandle:
    ...
    def make_playable() -> None: ...
    def is_seekable() -> bool: ...
    def seek_time() -> float: ...
    async def get_info() -> TrackState: ...
    def enable_loop() -> None: ...
    def disable_loop() -> None: ...
    def loop_for(count: int) -> None: ...
    @property
    def uuid() -> str: ...
    @property
