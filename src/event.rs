...
impl PyRtpType {
    ...
    fn __str__(&self) -> &str {
        match self.rtptype {
            RtpType::Pcmu => "<RtpType.Pcmu>",
            RtpType::Gsm => "<RtpType.Gsm>",
            RtpType::G723 => "<RtpType.G723>",
            // RtpType::Dvi4(ix) => &format!("<RtpType.Dvi4({})>", ix),
            RtpType::Dvi4(_ix) => "<RtpType.Dvi4>",
            RtpType::Lpc => "<RtpType.Lpc>",
            RtpType::Pcma => "<RtpType.Pcma>",
            RtpType::G722 => "<RtpType.G722>",
            RtpType::L16Stereo => "<RtpType.L16Stereo>",
            RtpType::L16Mono => "<RtpType.L16Mono>",
            RtpType::Qcelp => "<RtpType.Qcelp>",
            RtpType::Cn => "<RtpType.Cn>",
            RtpType::Mpa => "<RtpType.Mpa>",
            RtpType::G728 => "<RtpType.G728>",
            RtpType::G729 => "<RtpType.G729>",
            RtpType::CelB => "<RtpType.CelB>",
            RtpType::Jpeg => "<RtpType.Jpeg>",
            RtpType::Nv => "<RtpType.Nv>",
            RtpType::H261 => "<RtpType.H261>",
            RtpType::Mpv => "<RtpType.Mpv>",
            RtpType::Mp2t => "<RtpType.Mp2t>",
            RtpType::H263 => "<RtpType.H263>",
            RtpType::Dynamic(_ix) => "<RtpType.Dynamic>",
            RtpType::Reserved(_ix) => "<RtpType.Reserved>",
            RtpType::Unassigned(_ix) => "<RtpType.Unassigned>",
            RtpType::Illegal(_ix) => "<RtpType.Illegal>",
            // RtpType::Dynamic(ix) => &format!("<RtpType.Dynamic({})>", ix),
            // RtpType::Reserved(ix) => &format!("<RtpType.Reserved({})>", ix),
            // RtpType::Unassigned(ix) => &format!("<RtpType.Unassigned({})>", ix),
            // RtpType::Illegal(ix) => &format!("<RtpType.Illegal({})>", ix),
            _ => "<RtpType.?????>",
        }
    }
